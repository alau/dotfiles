...
vim.keymap.set("n", "<localleader>mo",
...
vim.keymap.set("n", "<localleader>mc", ":MoltenInterrupt<CR>",
               {desc = "interrupt execution", silent = true})
vim.keymap.set("n", "<localleader>md", ":MoltenDelete<CR>",
               {desc = "clear cell output", silent = true})
vim.keymap.set("n", "<localleader>mD", ":MoltenDelete!<CR>",
               {desc = "clear all cell output", silent = true})
...
vim.keymap.set("n", "<localleader>mr", runner.run_cell,
               {desc = "run cell", silent = true})
vim.keymap.set("n", "<localleader>ma", runner.run_above,
               {desc = "run cell and above", silent = true})
vim.keymap.set("n", "<localleader>mA", runner.run_all,
               {desc = "run all cells", silent = true})
vim.keymap.set("n", "<localleader>ml", runner.run_line,
               {desc = "run line", silent = true})
vim.keymap.set("v", "<localleader>m", runner.run_range,
